...
import com.shahzadakhtar.attendancecam.PermissionsDelegate;
...
public class AttendanceCamActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_attendance_cam);
